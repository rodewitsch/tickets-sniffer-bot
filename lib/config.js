...
// База для ссылок-диплинков на бота (см. renderWatchlist в lib/menus.js):
// <BOT_LINK_BASE>?start=unsub_<id> — тап открывает бота и шлёт /start с payload.
// Через неё («Мой список») пользователь отписывается от позиции по ссылке в сообщении.
export const BOT_LINK_BASE = `https://t.me/${BOT_USERNAME}`;
...
export const MINIAPP_URL = 'https://rodewitsch.github.io/tickets-sniffer-bot/?v=9&api=https://tickets-sniffer-bot.rodevich.com';
