...
Мини-приложение предлагает три режима: «Афиша / ByCard» (живой поиск событий и
площадок), «Ticketpro» и «Все источники» (отслеживание ключевого слова). Данные
передаются боту через `WebApp.sendData`.
